...
define( function( require ) {
  ...
  var privacyPolicyString = require( 'string!JOIST/privacyPolicy' );
  ...
  var donateToPhetString = require( 'string!JOIST/donateToPhet' );
  ...
  var Brand = {
    ...
    isPhetApp: phet.chipper.queryParameters[ 'phet-app' ],
